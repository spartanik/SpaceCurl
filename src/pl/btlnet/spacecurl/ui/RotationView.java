...
//		canvas.drawPath(mCircleProgressPath, mCircleProgressPaint);
	...
	private void useEvent(MotionEvent me){
		...
		float x = me.getX() - getMeasuredWidth() / 2;
		float y = me.getY() - getMeasuredHeight() / 2;
...
//	}
	...
	*/
	public interface OnCircularSeekBarChangeListener {
		...
		public abstract void onProgressChanged(RotationView circularSeekBar, int progress, boolean fromUser);

		public abstract void onStopTrackingTouch(RotationView seekBar);

		public abstract void onStartTrackingTouch(RotationView seekBar);
	}
